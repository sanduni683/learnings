...
class ShoppingApp extends Component
{
    ...
    {
        console.log( "ShoppingApp-Updated , means we have new state or new props, when there is change make ajax request to get new data from the server" )
    ...
    {
        console.log( "ShoppingApp-unmounted" )
    }

    render()
    {
        console.log( "ShoppingApp -rendered" )
        return (
            <div>
