...
import MainDivContent from './mainDivContent.jsx'
...
class ShoppingCartApp extends Component
{
    ...
    {
        super();
        console.log( "ShoppingCartApp-constructor called only once when an instance create, we can create more such instances." )
    }

    componentDidMount()
    {
        console.log( "ShoppingCartApp-Mounted ===> ajax call to get ata from the server" )
    }
    ...
    render()
    {
        console.log( "ShoppingCartApp-rendered ==> this is where component is rendering" )
        let totalCounters = 0;
